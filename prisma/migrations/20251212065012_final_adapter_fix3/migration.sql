/*
  ...
  - A unique constraint covering the columns `[userId]` on the table `Track` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Track_userId_key" ON "Track"("userId");
